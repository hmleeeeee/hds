...
!(function (t) {
				...
				for (e in s[n])
					(i = s[n][e]),
						s[n].hasOwnProperty(e) &&
							void 0 !== i &&
							(k.isPlainObject(i)
								? (t[e] = k.isPlainObject(t[e]) ? k.widget.extend({}, t[e], i) : k.widget.extend({}, i))
								: (t[e] = i));
			return t;
		}),
	...
	(x = Math.max),
		...
		(k.position = {
			...
			getScrollInfo: function (t) {
				...
				return {
					width:
						"scroll" === i || ("auto" === i && t.height < t.element[0].scrollHeight) ? k.position.scrollbarWidth() : 0,
			...
			flip: {
				left: function (t, e) {
					var i = e.within,
						...
						a = -2 * e.offset[0];
					r < 0
						? ((s = t.left + l + i + a + e.collisionWidth - n - s) < 0 || s < C(r)) && (t.left += l + i + a)
						: 0 < h &&
						  (0 < (o = t.left - e.collisionPosition.marginLeft + l + i + a - o) || C(o) < h) &&
						  (t.left += l + i + a);
				},
				top: function (t, e) {
					var i = e.within,
						...
						a = -2 * e.offset[1];
					r < 0
						? ((s = t.top + l + i + a + e.collisionHeight - n - s) < 0 || s < C(r)) && (t.top += l + i + a)
						: 0 < h &&
						  (0 < (o = t.top - e.collisionPosition.marginTop + l + i + a - o) || C(o) < h) &&
						  (t.top += l + i + a);
				}
			},
			flipfit: {
	...
	(k.ui.focusable = function (t, e) {
		...
		return "area" === a
			...
			: (/^(input|select|textarea|button|object)$/.test(a)
					? (n = !t.disabled) && (o = k(t).closest("fieldset")[0]) && (n = !o.disabled)
					: (n = ("a" === a && t.href) || e),
			  n &&
					k(t).is(":visible") &&
					(function (t) {
	...
	k.ui.focusable,
		...
		(k.ui.formResetMixin = {
			...
			_unbindFormResetHandler: function () {
				var t;
				this.form.length &&
					((t = this.form.data("ui-form-reset-instances")).splice(k.inArray(this, t), 1),
					t.length
						? this.form.data("ui-form-reset-instances", t)
			...
			this.element
				...
				.on("click." + this.widgetName, function (t) {
					if (!0 === k.data(t.target, e.widgetName + ".preventClickEvent"))
						return k.removeData(t.target, e.widgetName + ".preventClickEvent"), t.stopImmediatePropagation(), !1;
				}),
				(this.started = !1);
		},
				...
				return i && !s && this._mouseCapture(t)
					? ((this.mouseDelayMet = !this.options.delay),
					  ...
					  ((this._mouseStarted = !1 !== this._mouseStart(t)), !this._mouseStarted)
							? (t.preventDefault(), !0)
							: (!0 === k.data(t.target, this.widgetName + ".preventClickEvent") &&
									k.removeData(t.target, this.widgetName + ".preventClickEvent"),
	...
	k.widget("ui.draggable", k.ui.mouse, {
		...
		_mouseStop: function (t) {
			...
			return (
				...
				(k.isFunction(this.options.revert) && this.options.revert.call(this.element, i))
					...
					? "window" !== s.containment
						? "document" !== s.containment
							...
							: (this.containment = [
									0,
									0,
									k(n).width() - this.helperProportions.width - this.margins.left,
									(k(n).height() || n.body.parentNode.scrollHeight) - this.helperProportions.height - this.margins.top
							  ])
						: (this.containment = [
						...
						e._intersectsWith(e.containerCache) &&
							...
							k.each(n.sortables, function () {
								return (
									...
									(t =
										this !== e && this._intersectsWith(this.containerCache) && k.contains(e.element[0], this.element[0])
											? !1
											: t)
								);
							})),
				...
				o !== a && "HTML" !== o.tagName
					...
					: ((s.axis && "x" === s.axis) ||
							(t.pageY - k(a).scrollTop() < s.scrollSensitivity
								...
								: k(window).height() - (t.pageY - k(a).scrollTop()) < s.scrollSensitivity &&
								  (n = k(a).scrollTop(k(a).scrollTop() + s.scrollSpeed))),
					  (s.axis && "y" === s.axis) ||
							(t.pageX - k(a).scrollLeft() < s.scrollSensitivity
								? (n = k(a).scrollLeft(k(a).scrollLeft() - s.scrollSpeed))
								: k(window).width() - (t.pageX - k(a).scrollLeft()) < s.scrollSensitivity &&
								  (n = k(a).scrollLeft(k(a).scrollLeft() + s.scrollSpeed)))),
			...
			drag: function (t, e, i) {
				for (
					...
					(h = (r = i.snapElements[v].left - i.margins.left) + i.snapElements[v].width),
						...
						_ < l - p ||
						c + p < m ||
						!k.contains(i.snapElements[v].item.ownerDocument, i.snapElements[v].item)
							...
							: ("inner" !== d.snapMode &&
							  ...
							  !i.snapElements[v].snapping &&
									(s || n || o || a || u) &&
									i.options.snap.snap &&
									i.options.snap.snap.call(i.element, t, k.extend(i._uiHash(), { snapItem: i.snapElements[v].item })),
	...
	k.widget("ui.droppable", {
		...
		_setOption: function (t, e) {
			...
			"accept" === t
				...
				: "scope" === t &&
				  ((i = k.ui.ddmanager.droppables[this.options.scope]), this._splice(i), this._addToManager(e)),
				this._super(t, e);
		},
				...
				for (e in ((t = t || this.element), this.handles))
					this.handles[e].constructor === String
						...
						: (this.handles[e].jquery || this.handles[e].nodeType) &&
						  ((this.handles[e] = k(this.handles[e])), this._on(this.handles[e], { mousedown: a._mouseDown })),
						this.elementIsWrapper &&
	...
	k.ui.resizable,
		...
		k.widget("ui.sortable", k.ui.mouse, {
			...
			_mouseCapture: function (t, e) {
				...
				return (
					...
					!!(i = k.data(t.target, n.widgetName + "-item") === n ? k(t.target) : i) &&
						!(
							this.options.handle &&
							!e &&
							...
							(n = k.data(s[i], this.widgetFullName)) &&
								...
								a.push([
									k.isFunction(n.options.items)
										...
										: k(n.options.items, n.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"),
									n
								]);
				function h() {
					o.push(this);
			...
			refreshPositions: function (t) {
				...
				for (
					...
					((i = this.items[e]).instance !== this.currentContainer &&
						...
						((s = this.options.toleranceElement ? k(this.options.toleranceElement, i.item) : i.item),
			...
			_createHelper: function (t) {
				...
				return (
					t.parents("body").length ||
						k("parent" !== e.appendTo ? e.appendTo : this.currentItem[0].parentNode)[0].appendChild(t[0]),
						...
						((t.left += this.scrollParent.scrollLeft()), (t.top += this.scrollParent.scrollTop())),
					{
						top:
							(t =
								...
								(this.offsetParent[0].tagName && "html" === this.offsetParent[0].tagName.toLowerCase() && k.ui.ie)
									? { top: 0, left: 0 }
			...
			_convertPositionTo: function (t, e) {
				...
				var i = "absolute" === t ? 1 : -1,
					s =
						"absolute" !== this.cssPosition ||
						(this.scrollParent[0] !== this.document[0] && k.contains(this.scrollParent[0], this.offsetParent[0]))
							? this.scrollParent
							: this.offsetParent,
		...
		k.widget("ui.accordion", {
			...
			_activate: function (t) {
				...
				t !== this.active[0] &&
					((t = t || this.active[0]), this._eventHandler({ target: t, currentTarget: t, preventDefault: k.noop }));
			},
	...
	k.widget("ui.autocomplete", {
					...
					menufocus: function (t, e) {
						...
						(i = e.item.data("ui-autocomplete-item")),
							...
							(i = e.item.attr("aria-label") || i.value) &&
								k.trim(i).length &&
								(this.liveRegion.children().hide(), k("<div>").text(i).appendTo(this.liveRegion));
					},
		...
		_appendTo: function () {
			...
			return (t = !(t =
				!(t = t && (t.jquery || t.nodeType ? k(t) : this.document.find(t).eq(0))) || !t[0]
			...
			return t.length && t[0].label && t[0].value
				...
				: k.map(t, function (t) {
						return "string" == typeof t
							? { label: t, value: t }
							: k.extend({}, t, { label: t.label || t.value, value: t.value || t.label });
				  });
		},
		_suggest: function (t) {
			...
			_readType: function () {
				...
				(this.type = this.element[0].type),
					("input" === t && /radio|checkbox/.test(this.type)) ||
						k.error("Can't create checkboxradio on element.nodeName=" + t + " and element.type=" + this.type);
			},
			_enhance: function () {
	...
	k.widget("ui.button", {
		...
		_updateIcon: function (t, e) {
			...
			this.icon
				...
				t
					...
					: (this.iconSpace ||
							((this.iconSpace = k("<span> </span>")), this._addClass(this.iconSpace, "ui-button-icon-space")),
		...
		_setOption: function (t, e) {
			"icon" === t &&
				...
				this._super(t, e),
				"disabled" === t &&
					(this._toggleClass(null, "ui-state-disabled", e), (this.element[0].disabled = e) && this.element.blur());
		},
		refresh: function () {
	...
	k.extend(k.ui, { datepicker: { version: "1.12.1" } }),
		k.extend(v.prototype, {
			...
			_attachments: function (t, e) {
				...
				e.append && e.append.remove(),
					s &&
						((e.append = k("<span class='" + this._appendClass + "'>" + s + "</span>")),
			...
			_doKeyDown: function (t) {
				...
				if (((s._keyEvent = !0), k.datepicker._datepickerShowing))
					switch (t.keyCode) {
						...
						case 13:
							return (
								(i = k("td." + k.datepicker._dayOverClass + ":not(." + k.datepicker._currentClass + ")", s.dpDiv))[0] &&
									k.datepicker._selectDay(t.target, s.selectedMonth, s.selectedYear, i[0]),
								(e = k.datepicker._get(s, "onSelect"))
									? ((i = k.datepicker._formatDate(s)), e.apply(s.input ? s.input[0] : null, [i, s]))
									: k.datepicker._hideDatepicker(),
								!1
							);
						case 27:
						...
						case 33:
							k.datepicker._adjustDate(
								t.target,
								t.ctrlKey ? -k.datepicker._get(s, "stepBigMonths") : -k.datepicker._get(s, "stepMonths"),
								"M"
							);
							break;
						case 34:
			...
			_doKeyPress: function (t) {
				...
				if (k.datepicker._get(i, "constrainInput"))
					return (
						(e = k.datepicker._possibleChars(k.datepicker._get(i, "dateFormat"))),
				...
				if (t.input.val() !== t.lastVal)
					try {
						k.datepicker.parseDate(
							...
							(k.datepicker._setDateFromField(t), k.datepicker._updateAlternate(t), k.datepicker._updateDatepicker(t));
					} catch (t) {}
				return !0;
			},
			...
			_findPos: function (t) {
				for (
					...
					t && ("hidden" === t.type || 1 !== t.nodeType || k.expr.filters.hidden(t));
			...
			parseDate: function (e, n, t) {
				...
				for (
					var a,
						...
						h,
						l = 0,
						c = (t ? t.shortYearCutoff : null) || this._defaults.shortYearCutoff,
				...
				if (
					(h = this._daylightSavingAdjust(new Date(g, m - 1, _))).getFullYear() !== g ||
					h.getMonth() + 1 !== m ||
					h.getDate() !== _
				)
					throw "Invalid date";
					...
					t =
						null == t || "" === t
							...
							? (function (t) {
									...
									for (
										var e = (t.toLowerCase().match(/^c/) ? k.datepicker._getDate(r) : null) || new Date(),
											i = e.getFullYear(),
											s = e.getMonth(),
											n = e.getDate(),
			...
			_attachHandlers: function (t) {
				...
				t.dpDiv.find("[data-handler]").map(function () {
					var t = {
						...
						selectDay: function () {
							return (
								k.datepicker._selectDay(i, +this.getAttribute("data-month"), +this.getAttribute("data-year"), this), !1
							);
						},
			...
			_generateHTML: function (t) {
				...
				if ((K < 0 && ((K += 12), U--), q))
					for (
						e = this._daylightSavingAdjust(new Date(q.getFullYear(), q.getMonth() - R[0] * R[1] + 1, q.getDate())),
							e = j && e < j ? j : e;
				...
				for (
					t.drawMonth = K,
						...
						L = F ? this.formatDate(L, this._daylightSavingAdjust(new Date(U, K - O, 1)), this._getFormatConfig(t)) : L,
						...
						E = F ? this.formatDate(E, L, this._getFormatConfig(t)) : E,
						F = t.inline
							? ""
					...
					for (_ = "", this.maxRows = 4, v = 0; v < R[1]; v++) {
						if (
							((b = this._daylightSavingAdjust(new Date(U, K, t.selectedDay))), (y = " ui-corner-all"), (w = ""), B)
						) {
						...
						for (
							w +=
								...
								this._generateMonthYearHeader(t, K, U, j, q, 0 < m || 0 < v, h, l) +
								"</div><table class='ui-datepicker-calendar'><thead><tr>",
								k = o ? "<th class='ui-datepicker-week-col'>" + this._get(t, "weekHeader") + "</th>" : "",
								g = 0;
							g < 7;
							g++
						)
						...
						for (
							w += k + "</tr></thead><tbody>",
								...
								D = Math.ceil((C + D) / 7),
								I = B && this.maxRows > D ? this.maxRows : D,
								this.maxRows = I,
								...
								(S = c ? c.apply(t.input ? t.input[0] : null, [T]) : [!0, ""]),
									...
									(M +=
										...
										(H && !u
											...
											: " " +
											  S[1] +
											  (T.getTime() === Y.getTime() ? " " + this._currentClass : "") +
											  (T.getTime() === A.getTime() ? " ui-datepicker-today" : "")) +
										"'" +
										...
										(H && !u
											...
											: "<a class='ui-state-default" +
											  (T.getTime() === A.getTime() ? " ui-state-highlight" : "") +
											  (T.getTime() === Y.getTime() ? " ui-state-active" : "") +
						...
						11 < ++K && ((K = 0), U++),
							(_ += w +=
								"</tbody></table>" +
								(B
									? "</div>" + (0 < R[0] && v === R[1] - 1 ? "<div class='ui-datepicker-row-break'></div>" : "")
									: ""));
					}
					f += _;
				}
			...
			_generateMonthYearHeader: function (t, e, i, s, n, o, a, r) {
				...
				if (o || !g) b += "<span class='ui-datepicker-month'>" + a[e] + "</span>";
					...
					for (
						...
						(!h || c >= s.getMonth()) &&
							(!l || c <= n.getMonth()) &&
							(b += "<option value='" + c + "'" + (c === e ? " selected='selected'" : "") + ">" + r[c] + "</option>");
					b += "</select>";
				}
				if ((_ || (v += b + (!o && g && m ? "" : "&#xa0;")), !t.yearshtml))
					if (((t.yearshtml = ""), o || !m)) v += "<span class='ui-datepicker-year'>" + i + "</span>";
						...
						for (
							...
							t.yearshtml +=
								"<option value='" + p + "'" + (p === i ? " selected='selected'" : "") + ">" + p + "</option>";
		...
		(k.fn.datepicker = function (t) {
			...
			k.datepicker.initialized ||
				(k(document).on("mousedown", k.datepicker._checkExternalClick), (k.datepicker.initialized = !0)),
			...
			return ("string" == typeof t && ("isDisabled" === t || "getDate" === t || "widget" === t)) ||
				...
				: this.each(function () {
						"string" == typeof t
							? k.datepicker["_" + t + "Datepicker"].apply(k.datepicker, [this].concat(e))
		...
		k.widget("ui.selectmenu", [
			k.ui.formResetMixin,
			{
				...
				_documentClick: {
					mousedown: function (t) {
						this.isOpen &&
							(k(t.target).closest(".ui-selectmenu-menu, #" + k.ui.escapeSelector(this.ids.button)).length ||
								this.close(t));
					}
				},
				_buttonEvents: {
		...
		_events: {
			...
			"mouseenter .ui-spinner-button": function (t) {
				if (k(t.currentTarget).hasClass("ui-state-active"))
					return (
						!1 !== this._start(t) && void this._repeat(null, k(t.currentTarget).hasClass("ui-spinner-up") ? 1 : -1, t)
					);
			},
	...
	k.widget("ui.tabs", {
		...
		_panelKeydown: function (t) {
			this._handlePageNav(t) ||
				(t.ctrlKey && t.keyCode === k.ui.keyCode.UP && (t.preventDefault(), this.active.trigger("focus")));
		},
		...
		_setOptionDisabled: function (t) {
			var e, i;
			for (
				k.isArray(t) && (t.length ? t.length === this.anchors.length && (t = !0) : (t = !1)), i = 0;
				(e = this.tabs[i]);
				i++
			)
				(e = k(e)),
		...
		_activate: function (t) {
			...
			t[0] !== this.active[0] &&
				...
				this._eventHandler({ target: t, currentTarget: t, preventDefault: k.noop }));
		},
		_findActive: function (t) {
		...
		_getIndex: function (t) {
			return (t =
				"string" == typeof t ? this.anchors.index(this.anchors.filter("[href$='" + k.ui.escapeSelector(t) + "']")) : t);
		},
		_destroy: function () {
			this.xhr && this.xhr.abort(),
	...
	(k.effects = { effect: {} }),
						...
						(N.fn[a] = function (t) {
							...
							return "undefined" === i
								...
								: ("function" === i && ((t = t.call(this, o)), (i = S.type(t))),
								  null == t && r.empty
										? this
										: ("string" === i && (e = O.exec(t)) && (t = o + parseFloat(e[2]) * ("+" === e[1] ? 1 : -1)),
										  (n[r.idx] = t),
										  this[s](n)));
						});
				});
			...
			R(t, function (t, o) {
				(S.cssHooks[o] = {
					...
					(S.fx.step[o] = function (t) {
						t.colorInit || ((t.start = N(t.elem, o)), (t.end = N(t.end)), (t.colorInit = !0)),
			...
			toggleClass:
				...
				function (t, e, i, s, n) {
					return "boolean" == typeof e || void 0 === e
						? i
							? k.effects.animateClass.call(this, e ? { add: t } : { remove: t }, i, s, n)
				...
				removeWrapper: function (t) {
					...
					return (
						t.parent().is(".ui-effects-wrapper") &&
							(t.parent().replaceWith(t), (t[0] !== e && !k.contains(t[0], e)) || k(e).trigger("focus")),
						t
					);
				}
			}),
		...
		(k.fx.step.clip = function (t) {
			t.clipInit ||
				((t.start = k(t.elem).cssClip()), "string" == typeof t.end && (t.end = at(t.end, t.elem)), (t.clipInit = !0)),
				k(t.elem).cssClip({
	...
	var rt = k.effects;
	k.effects.define("disabled", "hide", function (t, e) {
		var i = {
				up: ["bottom", "top"],
				vertical: ["bottom", "top"],
				down: ["top", "bottom"],
		...
		k.effects.define("size", function (s, e) {
			...
			k.effects.createPlaceholder(i),
				...
				("box" !== l && "both" !== l) ||
					(n.from.y !== n.to.y &&
						((f = k.effects.setTransition(i, o, n.from.y, f)), (g = k.effects.setTransition(i, o, n.to.y, g))),
					n.from.x !== n.to.x &&
						((f = k.effects.setTransition(i, a, n.from.x, f)), (g = k.effects.setTransition(i, a, n.to.x, g)))),
				("content" !== l && "both" !== l) ||
					(n.from.y !== n.to.y &&
						((f = k.effects.setTransition(i, t, n.from.y, f)), (g = k.effects.setTransition(i, t, n.to.y, g)))),
				c &&
				...
				("content" !== l && "both" !== l) ||
					...
					i.find("*[width]").each(function () {
						...
						n.from.y !== n.to.y &&
							((i = k.effects.setTransition(t, o, n.from.y, i)), (e = k.effects.setTransition(t, o, n.to.y, e))),
							n.from.x !== n.to.x &&
								((i = k.effects.setTransition(t, a, n.from.x, i)), (e = k.effects.setTransition(t, a, n.to.x, e))),
				...
				i.animate(g, {
					...
					complete: function () {
						...
						0 === g.opacity && i.css("opacity", f.opacity),
							h || (i.css("position", "static" === u ? "relative" : u).offset(t), k.effects.saveStyle(i)),
							e();
					}
				});
		}),
